 ...
 * Implements Comparable interface to allow sorting vehicles by registration code.
 */
public abstract class Vehicle implements Comparable<Vehicle> {
     ...
     * Initializes the vehicle with the provided attributes and an empty list of workshop tasks.
     * 
     * @param registrationCode The registration code of the vehicle
     * @param model The model of the vehicle
     * @param type The type of vehicle (e.g., CAR, MOTORCYCLE, VAN, TRUCK)
...
//    }
     ...
     * @return the workshop task at the specified index, or null if the index is out of bounds
     */
     ...
     * The format is: "registrationCode;model;proprietary;workshopTasksSize" followed by a newline character.
     *
